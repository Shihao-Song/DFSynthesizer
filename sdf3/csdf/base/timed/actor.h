 ...
 *
 * $Id: actor.h,v 1.2.2.1 2010-04-25 01:21:16 mgeilen Exp $
 *
...
namespace CSDF
{
    ...
    class TimedCSDFactor : public CSDFactor
    {
        ...
        public:
            ...
            // Execution time
            CSDFtimeSequence &getExecutionTime() const;
    ...
    typedef list<TimedCSDFactor *>           TimedCSDFactors;
    typedef TimedCSDFactors::iterator        TimedCSDFactorsIter;
    typedef TimedCSDFactors::const_iterator  TimedCSDFactorsCIter;
