...
#ifndef FSMSADF_RESOURCE_ALLOCATION_FLOW_COMPSOC_PLATFORM_TILE_GRAPH_BINDING_H_INCLUDED
#define FSMSADF_RESOURCE_ALLOCATION_FLOW_COMPSOC_PLATFORM_TILE_GRAPH_BINDING_H_INCLUDED
...
namespace FSMSADF
{
     ...
     */
    class GraphBindingCompSoCPlatform : public GraphBindingBase
    {

            // Constructor
        public:
            GraphBindingCompSoCPlatform(PlatformBinding *b)
                : GraphBindingBase(b)
            {
